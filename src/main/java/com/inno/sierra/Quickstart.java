...
public class Quickstart {
     ...
     * @throws IOException
     */
    public boolean getEventsWindow(DateTime timeMin, DateTime timeMax) throws IOException {
        boolean isFree= true;
        ...
        if(items.isEmpty()){
            ...
            for(Event event: items){
                ...
                System.out.println("Starts at "+event.getStart().getDateTime()+
                        "and ends at "+event.getEnd().getDateTime());
            }
        }
        return isFree;
    }
